...
func TestIdCard(t *testing.T) {
	...
	if valid.IdCard("", "idcard").Ok {
		t.Error("\"00008888\" is a valid idcard should be false")
	}
	if !valid.IdCard("536000", "idcard").Ok {
		t.Error("\"536000\" is a valid idcard should be true")
	}
}
